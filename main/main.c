...
void init_i2s_inmp441()
{
    ...
    // 4. Registra a função de interrupção (Callback) antes de ligar o canal
...
{
    static int32_t raw_buffer[BLOCK_SIZE]; // Buffer intermediário para leitura
    size_t bytes_read = 0;

    // Lê dados do I2S (não bloqueante)
